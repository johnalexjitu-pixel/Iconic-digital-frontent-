    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="relative mb-12">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-6xl font-bold font-lexend mb-4">Innovation in action with IBM</h1>
              <p className="text-xl font-lexend">Driving digital transformation through strategic marketing</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 font-lexend mb-6">About IBM Partnership</h2>
            <p className="text-gray-600 font-lexend mb-6 leading-relaxed">
              Our collaboration with IBM focused on showcasing their cutting-edge technology solutions and 
              digital transformation capabilities. Working with one of the world's leading technology companies, 
              we developed marketing strategies that highlighted IBM's innovation in AI, cloud computing, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-lexend">
                    To communicate complex technology solutions in an accessible way while maintaining IBM's 
                    position as an industry leader. The challenge was to create compelling content that 
                    resonated with enterprise decision-makers while showcasing the practical benefits of 
                    IBM's innovative technologies.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-600 font-lexend mb-6 text-center">
              We developed a comprehensive B2B marketing strategy that positioned IBM's technology solutions 
              as essential tools for digital transformation. Our approach combined thought leadership content, 
              technical case studies, and targeted campaigns to reach enterprise decision-makers.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">Thought Leadership</h3>
                <p className="text-gray-600 font-lexend text-sm">Content strategy showcasing IBM's expertise and vision</p>
              </Card>
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">Technical Content</h3>
                <p className="text-gray-600 font-lexend text-sm">Case studies and technical documentation for enterprise audiences</p>
              </Card>
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">B2B Campaigns</h3>
                <p className="text-gray-600 font-lexend text-sm">Targeted advertising and lead generation for enterprise clients</p>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-8 mb-12">
          <div className="max-w-4xl mx-auto text-center">
            <blockquote className="text-xl text-gray-700 font-lexend italic mb-6">
              "Working with Iconic Digital has been instrumental in communicating our complex technology 
              solutions to enterprise audiences. Their strategic approach and creative execution have 
              helped us reach key decision-makers effectively."
            </blockquote>
            <div className="flex items-center justify-center gap-4">
              ...
              />
              <div>
                <p className="font-semibold text-gray-900">IBM Marketing Team</p>
