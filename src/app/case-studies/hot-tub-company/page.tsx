...
export default function HotTubCompanyCaseStudy() {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="relative mb-12">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-6xl font-bold font-lexend mb-4">Making waves for The Hot Tub & Swim Spa Company</h1>
              <p className="text-xl font-lexend">Providing an outsourced marketing function for the UK's leading wellness brand</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Card className="p-6 text-center bg-red-50 border-red-200">
            ...
            <h3 className="text-3xl font-bold text-red-600 mb-2">427:1</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 font-lexend mb-6">About The Hot Tub and Swim Spa Company</h2>
            <p className="text-gray-600 font-lexend mb-6 leading-relaxed">
              The Hot Tub and Swim Spa Company is UK's number 1 wellness expert, providing exceptional self-cleaning hot tubs, 
              swim spas, saunas and steam rooms, backed by 35 years of outstanding customer service. They are the only company 
              to win 4 Hydropool UK awards including "Overall Retailer of the Year 2022" and "Customer Service Excellence 2022".
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-lexend">
                    To provide a results-focussed, outsourced marketing solution. A family run business with exceptional ethos 
                    and big expansion goals needed a digital marketing partner to revamp their website, position content to their 
                    audiences, inspire growth across social media and deliver more leads through search engines.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-600 font-lexend mb-6 text-center">
              Amazing marketing results with a 427:1 return on investment. From the outset, Iconic Digital worked with the 
              business owners to understand the sales model, including analysis of Search Engine Ranking Performance and 
              introducing marketing personas at each stage of the funnel.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">SEO Strategy</h3>
                <p className="text-gray-600 font-lexend text-sm">Optimized content and technical SEO for better search rankings</p>
              </Card>
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">Paid Advertising</h3>
                <p className="text-gray-600 font-lexend text-sm">Strategic PPC campaigns targeting high-value keywords</p>
              </Card>
              <Card className="p-6 text-center">
                <h3 className="font-semibold text-gray-900 mb-2">Social Media</h3>
                <p className="text-gray-600 font-lexend text-sm">Engaging content strategy across all social platforms</p>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-8 mb-12">
          <div className="max-w-4xl mx-auto text-center">
            <blockquote className="text-xl text-gray-700 font-lexend italic mb-6">
              "Iconic Digital's customer service is first class and we have felt very supported every step of the way. 
              We would highly recommend this superb company to anyone!!"
            </blockquote>
            <div className="flex items-center justify-center gap-4">
              <Image
                src="/our-work/logo-min-1-removebg-preview.webp"
                alt="Hot Tub Company Logo"
                width={60}
                height={60}
                className="rounded-full"
              />
              <div>
                <p className="font-semibold text-gray-900">Christina Mantoura</p>
                <p className="text-gray-600">MD, The Hot Tub and Swim Spa Company</p>
              </div>
            </div>
          </div>
        </div>
